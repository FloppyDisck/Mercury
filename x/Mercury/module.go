...
import (
	...
	"github.com/FloppyDisck/Mercury/x/Mercury/client/cli"
...
func NewAppModule(cdc codec.Marshaler, keeper keeper.Keeper, ak authkeeper.AccountKeeper, bk bankkeeper.Keeper) AppModule {
	return AppModule{
