...
func (m *AvgReview) Reset()         { *m = AvgReview{} }
func (m *AvgReview) String() string { return proto.CompactTextString(m) }
func (*AvgReview) ProtoMessage()    {}
func (*AvgReview) Descriptor() ([]byte, []int) {
	return fileDescriptor_03535a4b640b7547, []int{1}
}
func (m *AvgReview) XXX_Unmarshal(b []byte) error {
	return m.Unmarshal(b)
}
func (m *AvgReview) XXX_Marshal(b []byte, deterministic bool) ([]byte, error) {
	if deterministic {
		return xxx_messageInfo_AvgReview.Marshal(b, m, deterministic)
	} else {
		b = b[:cap(b)]
		n, err := m.MarshalToSizedBuffer(b)
		if err != nil {
...
func (m *AvgReview) XXX_Merge(src proto.Message) {
	xxx_messageInfo_AvgReview.Merge(m, src)
}
func (m *AvgReview) XXX_Size() int {
	return m.Size()
}
func (m *AvgReview) XXX_DiscardUnknown() {
	xxx_messageInfo_AvgReview.DiscardUnknown(m)
}

var xxx_messageInfo_AvgReview proto.InternalMessageInfo

func (m *AvgReview) GetAverage() uint32 {
	if m != nil {
		return m.Average
	}
	return 0
...
func (m *AvgReview) GetCount() uint32 {
	if m != nil {
		return m.Count
	}
	return 0
...
func (m *AvgReview) GetSum() uint32 {
	if m != nil {
		return m.Sum
	}
	return 0
...
func init() {
	...
	proto.RegisterType((*AvgReview)(nil), "FloppyDisck.Mercury.Mercury.AvgReview")
}
...
var fileDescriptor_03535a4b640b7547 = []byte{
	...
	,
}
...
func (m *AvgReview) Marshal() (dAtA []byte, err error) {
	size := m.Size()
	dAtA = make([]byte, size)
	n, err := m.MarshalToSizedBuffer(dAtA[:size])
	if err != nil {
...
func (m *AvgReview) MarshalTo(dAtA []byte) (int, error) {
	size := m.Size()
	return m.MarshalToSizedBuffer(dAtA[:size])
}

func (m *AvgReview) MarshalToSizedBuffer(dAtA []byte) (int, error) {
	i := len(dAtA)
	_ = i
	var l int
	_ = l
...
func (m *AvgReview) Unmarshal(dAtA []byte) error {
	l := len(dAtA)
	iNdEx := 0
	for iNdEx < l {
		preIndex := iNdEx
		...
		wireType := int(wire & 0x7)
		if wireType == 4 {
			return fmt.Errorf("proto: AvgReview: wiretype end group for non-group")
		}
		if fieldNum <= 0 {
			return fmt.Errorf("proto: AvgReview: illegal tag %d (wire type %d)", fieldNum, wire)
		}
		switch fieldNum {
		case 1:
			if wireType != 0 {
